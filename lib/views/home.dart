...
//                   _buildMenuItem(context, "Đơn thuốc của bệnh nhân", Icons.local_pharmacy, '/medical_record_medicine', const Color.fromARGB(255, 100, 183, 255)),
...
//             image: NetworkImage(
//               'https://png.pngtree.com/background/20210711/original/pngtree-medical-mobile-system-mobile-app-therapy-hospital-poster-background-picture-image_1120959.jpg',
//             ),
//             fit: BoxFit.cover,
//           ),
//         ),
...
//               const CircleAvatar(
//                 radius: 50,
//                  // Đảm bảo có ảnh trong thư mục assets
//               ),
//               const SizedBox(height: 10),
//               const Text(
//                 'Admin App',
...
//                   color: Colors.black, // Thay đổi màu để hiển thị tốt trên nền sáng
//                 ),
//               ),
//               const SizedBox(height: 20),
//               Expanded(
  ...
  Widget _buildMenuItem(BuildContext context, String title, IconData icon, String route, Color color) {
    return GestureDetector(
      ...
      child: Card(
        color: color,
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(200), // Làm bo góc tròn hơn
          side: BorderSide(
