...
//     );
//     print('Lỗi khi tải dữ liệu: $e'); // Hiện thông tin lỗi ra console
//   }
// }
...
//     );
//     print('Thêm hồ sơ y tế thất bại: ${response['message'] ?? 'Không rõ lỗi'}'); // In ra chi tiết lỗi
//   }
// } catch (e) {
...
//   );
//   print('Lỗi xảy ra: $e'); // In lỗi ra console
// } finally {
//   setState(() {
//     _isLoading = false;
//   });
